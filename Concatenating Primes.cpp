/* If you like numbers, you may have been fascinated by prime numbers. Sometimes we obtain by concatenating two primes.
   ...
   that could be obtained by concatenating primes ≤ a given integer N.

Input Format -> Integer N

Output Format -> M, the number of distinct primes that could be obtained by concatenating two primes ≤ N
